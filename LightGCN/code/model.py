...
# random normal init seems to be a better choice when lightGCN actually don't use any non-linear activation function
        ...
        kg_word_emb = "/home/stu4/project/lightgcn/data/" + world.dataset + "/chatglm_word_features.pkl"
        # kg_image_emb = "../data/" + world.dataset + "/kg_image_emb.pkl"
        user_embedding = self.readEmbedding(kg_word_emb)
        user_embedding_tensor = torch.tensor(user_embedding, dtype=torch.float)
        self.linear_f = nn.Linear(4096, 2048)
        user_embedding_tensor = self.linear_f(user_embedding_tensor)
